...
create table "DEBIANBINARYPACKAGES" ("repoid" INTEGER NOT NULL,"fileid" VARCHAR NOT NULL,"controlfile" VARCHAR NOT NULL);
create table "DEBIANREPOSITORIES" ("repoid" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,"name" VARCHAR NOT NULL);
